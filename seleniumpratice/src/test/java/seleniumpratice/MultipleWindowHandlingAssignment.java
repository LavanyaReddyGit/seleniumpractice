...
public class MultipleWindowHandlingAssignment {
	 ...
	 public static void main(String[] args)
	 {
		...
		WebElement resultsModule= driver.findElement(By.xpath("//div[@id='Wikipedia1_wikipedia-search-results']"));
		List<WebElement>  searchLinks=resultsModule.findElements(By.tagName("a"));
	    System.out.println("No.of links:"+searchLinks.size());
	    
	    
	    //printing & clicking all links
	    System.out.println("printing & clicking all links.....");
